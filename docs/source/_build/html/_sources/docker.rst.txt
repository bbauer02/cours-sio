...
Ce cours est découpé en différent chapitre et permet un apprentissage progressif des différents concepts et de leur mise en pratique. 
...
Il s’agit d’une autre technologie Linux qui va permettre de limiter les ressources qu’un processus va utiliser. 
...
Il existe une branche de la Linux Foundation : la CNCF (Cloud Native Computing Foundation) qui porte de nombreux projets « Cloud Native » comme :

* Kubernetes
* Prometheus
* Fluentd
  
Site de la cncf : www.cncf.io
...
2.3 [Exercice] - Installation avec Multipass
********************************************

2.4 [Exercice] - Installation avec Vagrant
********************************************

2.5 [Exercice] - Installation avec Terraform
********************************************

2.6 [Démo] play-with-docker.com
********************************************

2.7 [Pour aller plus loin] Configuration du daemon
***************************************************

2.8 [Pour aller plus loin] Communication client / serveur
***********************************************************

2.9 Quiz : La plateforme Docker
**********************************
